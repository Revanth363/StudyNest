    ...
    <div className="auth-page">
      <div className="auth-left">
        <div className="auth-brand">
          ...
          <p className="auth-sub">
            Join thousands of CS students preparing for GATE, placements, and competitive programming — all in one place.
          </p>
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          <p className="auth-desc">Sign in to your StudyNest account</p>
